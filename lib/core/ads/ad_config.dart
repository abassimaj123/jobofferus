...
/// Production IDs are injected at build time via --dart-define-from-file=admob.json
/// (see admob.example.json). When absent, falls back to Google official TEST IDs,
/// so a release build never ships placeholder ad unit IDs.
class AdConfig {
